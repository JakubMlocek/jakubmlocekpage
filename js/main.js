  ...
  },
  {
    ...
    detail: {
      ...
      paragraphs: [
        ...
        "To make the host observable rather than a black box, the role also configures structured JSON access logging, persistent journald storage, log rotation, and <code>auditd</code> rules that watch configuration files, secrets, and privileged service commands — then enrolls the host as a SIEM agent so all of that telemetry flows into the same central monitoring used across the rest of the infrastructure.",
      ],
    },
  },
  {
