...
Personal portfolio & CV — Jakub Mlocek, Cybersecurity Engineer.
...
- `js/main.js` — content data (edit `EDUCATION`, `EXPERIENCE`, `PROJECTS` arrays here to update the site) + interactivity
